...
import {NetworkRequest, NetworkRequestLogData} from "../loaders/network_statistic_loader.ts";
...
const RequestLog: React.FC = () => {
    ...
    // @ts-expect-error
    const data: NetworkRequestLogData = useLoaderData();
            ...
            <div className="mb-6">
                ...
                <div className="flex overflow-x-auto space-x-4">
                    {data?.results.requests_by_method.map((methodData) => (
                        <div key={methodData.method} className="bg-gray-100 p-4 rounded-lg shadow-md min-w-[120px] text-center">
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 md:w-1/2">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button onClick={() => setSelectedRequest(null)} className="text-gray-500 hover:text-gray-800">
                                ✖
                            </button>
                        </div>
                        <div>
                            ...
                            {/* You can extend this to include request/response body if needed */}
                        </div>
                    </div>
                </div>
            )}
